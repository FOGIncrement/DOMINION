...
INSERT INTO "new_Company" ("autoStaff", "cash", "closedAt", "foundedAt", "goodsStock", "id", "industry", "inputStock", "ipoAt", "isPublic", "lastTickAt", "level", "name", "ownerId", "sharePrice", "sharesOutstanding", "totalExpenses", "totalRevenue", "workersAssigned") SELECT "autoStaff", "cash", "closedAt", "foundedAt", "goodsStock", "id", "industry", "inputStock", "ipoAt", "isPublic", "lastTickAt", "level", "name", "ownerId", "sharePrice", "sharesOutstanding", "totalExpenses", "totalRevenue", "workersAssigned" FROM "Company";
DROP TABLE "Company";
